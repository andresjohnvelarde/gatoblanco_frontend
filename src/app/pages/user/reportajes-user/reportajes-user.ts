...
import { ModalCeReportaje } from '../modal-ce-reportaje/modal-ce-reportaje';
...
@Component({
  selector: 'app-reportajes-user',
  imports: [Titulo, CommonModule, FormsModule, ModalCeReportaje, ModalEliminar],
  templateUrl: './reportajes-user.html',
  styleUrl: './reportajes-user.css',
})
export class ReportajesUser {
  ...
  cargarNoticias() {
    ...
    this.publicacionService.listarAdmin('reportaje').subscribe({
      next: (data) => {
